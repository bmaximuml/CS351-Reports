...
\begin{figure}
  \begin{ganttchart}{1}{31}
    ...
    \ganttbar{Write Specification}{1}{2} \\
    \ganttmilestone{Submit Specification}{2} \\
    \ganttbar{Research Networking Concepts}{3}{3} \\
    \ganttbar{Research NetFPGA}{4}{4} \\
    \ganttbar{Research P4}{5}{6} \\
    \ganttbar{Write Progress Report}{8}{8} \\
    \ganttmilestone{Submit Progress Report}{9} \\
