...
\begin{figure}
  \begin{ganttchart}{1}{31}
    ...
    \ganttbar{Write Specification}{1}{1} \ganttnewline
    \ganttmilestone{Submit Specification}{2} \\
    \ganttlinkedbar{Task 2}{3}{7} \ganttnewline
    \ganttbar{Write Progress Report}{8}{8} \\
    \ganttmilestone{Submit Progress Report}{9} \ganttnewline
