...
If no level specified, the system defaults to INFO.
...
At this stage of implementation, the topology of the virtual network created by the system wass limited to a tree topology which could not be modified.
